...
?>
                <tbody>
                    <tr>
                        ...
                        <td><a href="update1.php?edit_id=<?php echo  $id ?>">Update</a> || <a onclick="return confirm('Are you sure?')" href="delete1.php".php?id=<?php echo  $id?> & $username=<?php echo $username ?> ">Delete</a> </td>
                    </tr>
                </tbody>
