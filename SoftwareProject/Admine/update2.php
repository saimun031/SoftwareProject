...
<p class="p-3 bg-dark text-white text-center">CareGiver Management System</p>        
    ...
    <?php 
        ...
        if(isset($_REQUEST['edit_id']))
        {
            ...
            $get_info = "SELECT * FROM alljobs WHERE  id = $rcv_id " ;
...
?>
             <form action="updatedata2.php" method="post">
                ...
                <b>Title</b><br>
                <input class="inputclass" type="text" value="<?php echo $row['title'] ?>" name="title" id="title" autocomplete="off"><br>

                 <b>Patients Info</b><br>
                <input class="inputclass" value="<?php echo $row['description'] ?>" type="description" name="description" id="description" autocomplete="off"><br><br>
                
                 

                <b>Amount</b><br>
                <input class="inputclass" value="<?php echo $row['price'] ?>" type="price" name="price" id="Amount" autocomplete="off"><br><br>
                
                
                <input class="btn btn-primary" type="submit" value="Update Data" name="update2" id="update2"><br>
